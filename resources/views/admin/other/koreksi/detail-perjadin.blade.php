      ...
      <div class="card">
        <div class="card-body content" id="content">
          ...
          <div class="row page_content page_5">
            ...
            <form action="{{url('/koreksi/update/' . $status)}}" method="post" id="myForm">
              @csrf
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="min-width: 300px">
                          <select disabled class="form-control mySelect" name="sbmPegawai_{{$numpegawai}}">
                            @foreach ($sbms as $sbm)
                        ...
                        <td style="min-width: 200px">
                          <input readonly type="number" class="form-control num1 prevent-submit" min="0" name="uang_harian{{$numpegawai}}" value="{{$pesertaPegawai->uang_harian}}">
                        </td>
                        <td style="min-width: 200px">
                          <input readonly type="number" class="form-control num2 prevent-submit" min="0" name="uang_harian_fullday{{$numpegawai}}" value="{{$pesertaPegawai->uang_harian_fullday}}">
                        </td>
                        <td style="min-width: 200px">
                          <input readonly type="number" class="form-control num3 prevent-submit" min="0" name="uang_harian_fullboard{{$numpegawai}}" value="{{$pesertaPegawai->uang_harian_fullboard}}">
                        </td>
                        <td style="min-width: 200px">
                          <input readonly type="number" class="form-control num4 prevent-submit" min="0" name="uang_representasi{{$numpegawai}}" value="{{$pesertaPegawai->uang_representasi}}">
                          </td>
                        ...
                        <td style="min-width: 200px">
                          <input readonly type="date" class="result form-control" name="tglbayar_{{$numpegawai}}" value="{{ \Carbon\Carbon::parse($pesertaPegawai->tgl_bayar)->format('Y-m-d') }}" required>
                        </td>
                        <td>
                          <select disabled class="form-select" aria-label="Default select example" style="min-width: 150px" name="statuspegawai_{{$numpegawai}}">
                      ...
                      <tr>
                        ...
                        <td>
                          <select disabled class="form-select mySelect" aria-label="Default select example" style="min-width: 300px" name="sbmNonPegawai_{{$numnonpegawai}}">
                            @foreach ($sbms as $sbm)
                        ...
                        <td style="min-width: 200px">
                          <input type="date" class="result form-control" name="tglbayarnon_{{$numnonpegawai}}" value="{{ \Carbon\Carbon::parse($pesertaNonPegawai->tgl_bayar)->format('Y-m-d') }}">
                          </td>
                        <td>
              ...
              <table id="calculationTable2" name="Fasilitas" class="table table-bordered calculationTable" style="width: 100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    @if($perjadin->is_acceptKeu == 'selesai')
                        <td>
                        <select disabled class="js-example-basic-single-3 form-select" aria-label="Default select example" style="min-width: 300px" name="akunKebutuhan_{{$numkebutuhan}}">
                            @foreach ($akuns as $akun)
                                <option value="{{$akun->idAkun}}"
                        ...
                        <td>
                        <select disabled class="form-select mySelect" aria-label="Default select example" style="min-width: 300px" name="sbmKebutuhan_{{$numkebutuhan}}">
                            @foreach ($sbms as $sbm)
                        ...
                        <td style="min-width: 200px">
                        <input readonly type="number" class="result form-control" name="totalKebutuhan_{{$numkebutuhan}}" value="{{$kebutuhan->jumlah_harga}}">
                        </td>
                        <td style="min-width: 200px">
                        <input readonly type="datetime-local" class="result form-control" name="tglbayarKebutuhan_{{$numkebutuhan}}" value="{{ \Carbon\Carbon::parse($kebutuhan->tgl_bayar)->format('Y-m-d\TH:i') }}">
                        </td>
                        <td>
                        <select disabled class="form-select" aria-label=".form-select-sm example" style="min-width: 150px" name="kesesuaian_{{$numkebutuhan}}">
          ...
          <div class="col-md-12 mb-3">
                ...
                <div class="col-md-6 text-center">
                    <a href="{{ url('/koreksi/' . $status) }}" class="btn btn-warning tombol-kembali">
                      <i class="fas fa-arrow-left"></i> Kembali
                    </a>
                  <button class="btn btn-success submitButton" type="submit" name="action" value="koreksi-data">Koreksi Data</button>
                </div>
                <div class="col-md-3 text-start">
                </div>
