          ...
          <div class="card">
            <div class="card-body content" id="content">
              ...
              <div class="row page_content page_5">
                  ...
                  <form action="{{url('/koreksi/update/' . $status)}}" method="post">
                    @csrf
                                                            ...
                                                            <tr>
                                                                ...
                                                                @foreach ($keuangans as $keuangan)
                                                                    @if ($keuangan->perangkat_acara == $pegawai->idPerangkatAcara)
                                                                        ...
                                                                        {{-- TGL BAYAR PEGAWAI --}}
                                                                        <td style="min-width: 200px">
                                                                        <input readonly type="date" class="result form-control" name="tglbayarPegawai_{{$numpegawai}}" value="{{$keuangan->tgl_bayar}}">
                                                                        </td>
                                            ...
                                            @if ($nonpegawais->isNotEmpty())
                                                ...
                                                @if ($nonpegawai->fasilitas_id == $perangkat->id )
                                                    <tr>
                                                        ...
                                                        <td style="min-width: 200px">
                                                            <input  readonly type="date" class="result form-control" name="tglbayarNonPegawai_{{$numnonpegawai}}" value="{{$keuangan->tgl_bayar}}">
                                                        </td>
                                    ...
                                    @if ($keuanganoperasionals->isNotEmpty())
                                      @foreach ($keuanganoperasionals as $keuanganoperasional)
                                        @if ($keuanganoperasional->operasional == $operasional->id)
                                          ...
                                          @if (($info->is_acceptBend == 'approval-2'))
                                            <td style="min-width: 200px">
                                              <input required type="date" class="result form-control" name="tglbayarOperasional_{{$numoperasional}}" value="{{$keuanganoperasional->tgl_bayar}}" >
                                            </td>
                                            <td style="min-width: 150px">
