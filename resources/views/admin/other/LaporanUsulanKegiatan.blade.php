                    ...
                    <table id="myTable" class="table table-bordered data-table" style="width: 100%">
                      ...
                      @endphp
                        ...
                        <tr>
                            ...
                            <td>{{$kegiatan->Tgl_Terima_Berkas}}</td>
                            <td>{{$kegiatan->Tgl_Berkas_Lengkap}}</td>
                            <td>{{$kegiatan->Tgl_Surtug}}</td>
                                    ...
                                    @foreach ($kegiatan->dokumen_list as $dokumen)
                                        <li>
                                            @if (!empty($dokumen['file']))
                                                ...
                                                @endphp
                                                <a href="{{ route('kegiatan-getDokumen', ['filename' => $filename]) }}" target="_blank"></a>
                                            @else
                                                {{ $dokumen['nama_dokumen'] }}
                                            @endif
                                        </li>
                            ...
                            <td><input type="date" class="form-control dateInput" id="exampleInputEmail1" name="tglSpby_{{$numpegawai}}" value="{{$kegiatan->Tanggal_SPBY}}"></td>
                        ...
                        <tr>
                            ...
                            <td><input type="date" class="form-control dateInput" id="exampleInputEmail1" name="tglSpbyNon_{{$numnonpegawai}}" value="{{$kegiatanNon->Tanggal_SPBY}}"></td>
