        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="row page_content page_9">
                    ...
                    <form action="{{url('/c_konfirmasi_service_assets')}}" method="post" enctype="multipart/form-data">
                    @csrf
                      ...
                      <table id="example" class="table table-bordered" style="width: 100%">
                        ...
                        @foreach ($permohonanPegawais as $permohonanPegawai)
                            <tr>
                                ...
                                <td class='text-center'>
                                <span class="">
                                    <input type="hidden" name="idPermohonan_{{$numpermohonanPegawai}}" value="{{$permohonanPegawai->idPermohonan}}">
                                    {{-- <input class="form-check-input" type="checkbox" value="verifikasi-1" id="" name="statusPegawai_{{$numpermohonanPegawai}}"> --}}
                                    <select class="form-select" aria-label="Default select example" name="statusPegawai_{{$numpermohonanPegawai}}">
                                        <option value="pembayaran" selected>Tunggu</option>
                                        <option value="verifikasi-1">Konfirmasi</option>
                                    </select>
                                </span>
