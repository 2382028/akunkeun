                ...
                <div class="row page_content page_9">
                        ...
                        @foreach ($permohonans as $permohonan)
                            <tr>
                                ...
                                <td>
                                  ...
                                  <td style="min-width: 200px">
                                    <input type="date" class="result form-control" name="totalPermohonan_{{$numpermohonanAdmin}}" value="{{$permohonan->tgl_bayar}}" readonly>
                                  </td>
                                  <td>
                        ...
                        @foreach ($permohonanPegawais as $permohonanPegawai)
                            <tr>
                                ...
                                <td>
                                  ...
                                  <td style="min-width: 200px">
                                    <input type="date" class="result form-control" name="tglPermohonanPegawai_{{$numpermohonanPegawai}}" value="{{$permohonanPegawai->tgl_bayar}}" readonly>
                                  </td>
                                  <td>
                        ...
                        @foreach ($permohonanKendaraans as $permohonanKendaraan)
                            <tr>
                                ...
                                <td>
                                  ...
                                  <td style="min-width: 200px">
                                    <input type="date" class="result form-control" name="tglPermohonanKendaraan_{{$numpermohonanKendaraan}}" value="{{$permohonanKendaraan->tgl_bayar}}" readonly>
                                  </td>
                                  <td>
                        ...
                        @foreach ($permohonanRuangans as $permohonanRuangan)
                            <tr>
                                ...
                                <td>
                                  ...
                                  <td style="min-width: 200px">
                                    <input type="date" class="result form-control" name="totalPermohonanRuangan_{{$numpermohonanRuangan}}" value="{{$permohonanRuangan->tgl_bayar}}" readonly>
                                  </td>
                                  <td>
                  ...
                  <div class="col-md-12 mb-3">
                    <div class="d-grid gap-2 d-md-flex justify-content-center">
                        <a href="{{url('/service_bendahara_riwayat/' . 'selesai')}}" class="btn btn-dark">Kembali</a>
                    </div>
                  </div>
                </div>
                </form>
