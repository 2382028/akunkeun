...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <h4>BMN / Bag.Bendahara / <span class="fw-bold">Data Service</span></h4>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-bordered data-table" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <a href="{{url('/bmn_bendahara/detail/' . $penyedia->idService)}}" class="btn btn-primary"><i class="fa-solid fa-check pt-1"></i> Approval</a>
                                </td>
                            </tr>
                            @endforeach
                            ...
                            <tr>
                                ...
                                <td class='text-center d-flex justify-content-evenly'>
                                <a href="{{url('/bmn_bendahara/detail/' . $penyediakendaraan->idService)}}" class="btn btn-primary"><i class="fa-solid fa-check pt-1"></i> Approval</a>
                                </td>
                            </tr>
                            @endforeach
                            ...
                            <tr>
                                ...
                                <td class='text-center d-flex justify-content-evenly'>
                                <a href="{{url('/bmn_bendahara/detail/' . $penyediaruangan->idService)}}" class="btn btn-primary"><i class="fa-solid fa-check pt-1"></i> Approval</a>
                                </td>
                            </tr>
                            @endforeach
                        </table>
