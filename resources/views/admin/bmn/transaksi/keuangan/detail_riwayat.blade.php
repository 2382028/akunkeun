...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <h4>BMN / Keuangan / <span class="fw-bold">{{$penyedia->nama_CV}}</span></h4>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="row page_content page_9">
                    ...
                    <form action="{{url('/c_keuangan_service')}}" method="post">
                        @csrf
                          ...
                          <table id="example" class="table table-bordered" style="width: 100%">
                            ...
                            @foreach ($dokumens as $dokumen)
                                <tr>
                                    ...
                                    <td>
                                        <span>
                                            <input type="hidden" name="idDokumen_{{$numdokumen}}" value="{{$dokumen->idDokumen}}">
                                ...
                                <td class='text-center' style="min-width: 150px">{{$permohonan->tgl_selesai}}</td>
                                  ...
                                  <td style="min-width: 100px">
                                    <div class="input-group mb-3">
                                      <input type="number" class="form-control num2" name="pajakPermohonan_{{$numpermohonanAdmin}}" value="{{$permohonan->pph}}">
                                      <span class="input-group-text" id="basic-addon2">%</span>
                                    </div>
                                  </td>
                                  <td style="min-width: 100px">
                                    <div class="input-group mb-3">
                                      <input type="number" class="form-control num3" name="pajakPermohonan22_{{$numpermohonanAdmin}}" value="{{$permohonan->pph22}}">
                                      <span class="input-group-text" id="basic-addon2">%</span>
                                    </div>
                                  </td>
                                  <td style="min-width: 100px">
                                    <div class="input-group mb-3">
                                      <input type="number" class="form-control num4" name="pajakPermohonan23_{{$numpermohonanAdmin}}" value="{{$permohonan->pph23}}">
                                      <span class="input-group-text" id="basic-addon2">%</span>
                                    </div>
                                  </td>
                                  <td style="min-width: 100px">
                                    <div class="input-group mb-3">
                                      <input type="number" class="form-control num5" name="pajakPermohonanppn_{{$numpermohonanAdmin}}" value="{{$permohonan->ppn}}">
                                      <span class="input-group-text" id="basic-addon2">%</span>
                                    </div>
                                  </td>
                                  <td style="min-width: 200px">
                                    <input type="number" class="result form-control" name="totalPermohonan_{{$numpermohonanAdmin}}" value="{{$permohonan->total}}">
                                  </td>
                            </tr>
                            @php
                                $numpermohonanAdmin++;
                        ...
                        @foreach ($permohonanPegawais as $permohonanPegawai)
                            <tr>
                                ...
                                <td class='text-center'>{{$permohonanPegawai->tgl_selesai}}</td>
                                  ...
                                  <td style="min-width: 200px">
                                    <input type="number" class="result form-control" name="totalPermohonanPegawai_{{$numpermohonanPegawai}}" value="{{$permohonanPegawai->nominal}}">
                                  </td>
                            </tr>
                            @php
                        ...
                        @foreach ($permohonanKendaraans as $permohonanKendaraan)
                            <tr>
                                ...
                                <td class='text-center' style="min-width: 150px">{{$permohonanKendaraan->tgl_selesai}}</td>
                                  ...
                                  <td style="min-width: 100px">
                                    <div class="input-group mb-3">
                                      <input type="number" class="form-control num5" name="pajakPermohonanKendaraanppn_{{$numpermohonanKendaraan}}" value="{{$permohonanKendaraan->ppn}}">
                                      <span class="input-group-text" id="basic-addon2">%</span>
                                    </div>
                                  </td>
                                  <td style="min-width: 200px">
                                    <input type="number" class="result form-control" name="totalPermohonanKendaraan_{{$numpermohonanKendaraan}}" value="{{$permohonanKendaraan->total}}">
                                  </td>
                            </tr>
                            @php
                        ...
                        @foreach ($permohonanRuangans as $permohonanRuangan)
                            <tr>
                                ...
                                <td class='text-center' style="min-width: 150px">{{$permohonanRuangan->tgl_selesai}}</td>
                                  ...
                                  <td style="min-width: 100px">
                                    <div class="input-group mb-3">
                                      <input type="number" class="form-control num5" name="pajakPermohonanRuanganppn_{{$numpermohonanRuangan}}" value="{{$permohonanRuangan->ppn}}">
                                      <span class="input-group-text" id="basic-addon2">%</span>
                                    </div>
                                  </td>
                                  <td style="min-width: 200px">
                                    <input type="number" class="result form-control" name="totalPermohonanRuangan_{{$numpermohonanRuangan}}" value="{{$permohonanRuangan->total}}">
                                  </td>
                            </tr>
                            @php
                  ...
                  <div class="col-md-12 mb-3">
                    <div class="d-grid gap-2 d-md-flex justify-content-center">
                        <a href="{{url('/service_keuangan_riwayat/' . 'selesai')}}" class="btn btn-dark">Kembali</a>
                    </div>
                  </div>
                </div>
                </form>
