                ...
                <div class="row page_content page_9">
                  ...
                  <div class="col-md-12 mb-3">
                    <div class="d-grid gap-2 d-md-flex justify-content-center">
                        <a href="{{url('/service_keuangan/' . 'verifikasi-1')}}" class="btn btn-dark">Kembali</a>
                        <button class="btn btn-success" type="submit">Verifikasi dan kirim ke bendahara untuk pencairan</button>
                    </div>
                  </div>
                </div>
                </form>
