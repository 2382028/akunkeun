                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-bordered data-table" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <a href="{{url('/bmn_keuangan/detail/' . $penyedia->idService)}}" class="btn btn-primary"><i class="fa-solid fa-check pt-1"></i> Verifikasi</a>
                                </td>
                            </tr>
                            @endforeach
                            ...
                            <tr>
                                ...
                                <td class='text-center d-flex justify-content-evenly'>
                                <a href="{{url('/bmn_keuangan/detail/' . $penyediaKendaraan->idService)}}" class="btn btn-primary"><i class="fa-solid fa-check pt-1"></i> Verifikasi</a>
                                </td>
                            </tr>
                            @endforeach
                            ...
                            <tr>
                                ...
                                <td class='text-center'>{{$penyediaRuangan->is_acceptKeu}}</td>
                                <td class='text-center d-flex justify-content-evenly'>
                                <a href="{{url('/bmn_keuangan/detail/' . $penyediaRuangan->idService)}}" class="btn btn-primary"><i class="fa-solid fa-check pt-1"></i> Verifikasi</a>
                                </td>
                            </tr>
                            @endforeach
                        </table>
