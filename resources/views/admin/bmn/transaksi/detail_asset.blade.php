...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <h4>BMN / Data Service Aset  <span class="fw-bold"></span></h4>
        </div>
    </div>
    <form action="{{url('/c_permohonan_service_asset')}}" method="post">
    @csrf
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                    ...
                    <div class="row">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="row small mb-3">
                                    <div class="col-3">Nama Asset</div>
                                    <div class="col-9">: {{$asset[0]->nama_barang}}</div>
                                </div>
                                <div class="row small mb-3">
                      ...
                      <div class="col-md-12 mb-3">
                        <div class="d-grid gap-2 d-md-flex justify-content-center">
                            <a href="{{url('/perbaikan_assets/' .  $permohonan->status)}}" class="btn btn-dark">Kembali</a> 
  ...
  <div class="modal fade" id="tambah_kebutuhan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form action="{{url('/c_service_komponen_asset')}}" method="post">
            @csrf
            <input type="hidden" name="idPermohonan" value="{{$permohonan->id}}">
            ...
            <div class="modal-body col-md-12">
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="" name="komponen" required> 
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-4">
