...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <h4>BMN / Data Service Kendaraan / <span class="fw-bold">{{$asset[0]->merek}} - {{$asset[0]->no_polisi}}</span></h4>
        </div>
    </div>
    <form action="{{url('/c_permohonan_service_kendaraan')}}" method="post">
    @csrf
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                    ...
                    <div class="row">
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="row small mb-3">
                                    <div class="col-3">Nama Kendaraan</div>
                                    <div class="col-9">: {{$asset[0]->merek}} - {{$asset[0]->no_polisi}}</div>
                                </div>
                                <div class="row small mb-3">
                      ...
                      <div class="col-md-12 mb-3">
                        <div class="d-grid gap-2 d-md-flex justify-content-center">
                            <a href="{{url('/service_kendaraan_all/' . $permohonan->status)}}" class="btn btn-dark">Kembali</a> 
  ...
  <div class="modal fade" id="tambah_kebutuhan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form action="{{url('/c_service_komponen_kendaraan')}}" method="post">
            @csrf
            <input type="hidden" name="idPermohonan" value="{{$permohonan->id}}">
