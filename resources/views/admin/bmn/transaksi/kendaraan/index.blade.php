                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-bordered data-table" style="width: 100%">
                            ...
                            <tr class="text-center small">
                                ...
                                <th class="th-md">Nama Kendaraan</th>
                            ...
                            <tr>
                                ...
                                <td>{{$serviceKendaraan->username}}</td>
                                <td>{{$serviceKendaraan->merek}} - {{$serviceKendaraan->no_polisi}}</td>
                                <td class='text-center'>{{$serviceKendaraan->status}}</td>
                                <td class='text-center d-flex justify-content-evenly'>
                                <a href="{{url('/service/detail_kendaraan/' . $serviceKendaraan->idService)}}" class="btn btn-primary"><i class="fa-solid fa-check pt-1"></i> Verifikasi</a>
                                </td>
                            </tr>
                            @endforeach
                        </table>
