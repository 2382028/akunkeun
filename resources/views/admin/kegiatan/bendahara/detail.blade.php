              ...
              <div class="row page_content page_5">
                                            ...
                                            @foreach ($pegawais as $pegawai)
                                                @if ($pegawai->fasilitas_id == $perangkat->id && $pegawai->kode == 'honor')
                                                    <tr>
                                                        ...
                                                        <input id="detail_satuan_{{$numpegawai}}"
                                                            type="hidden"
                                                            value="{{$pegawai->detail_satuan}}">
                                                        ...
                                                        <td style="min-width: 200px">
                                                                <input id="input_satuan_honorarium_panitia_{{$numpegawai}}"
                                                                    type="number"
                                                        ...
                                                        @else
                                                            <td style="min-width: 200px">
                                                                <input id="input_satuan_honorarium_{{$numpegawai}}"
                                                                    type="number"
                                                ...
                                                @elseif ($pegawai->fasilitas_id == $perangkat->id && $pegawai->sebagai == 'Supir' )
                                                    <tr>
                                                        ...
                                                        <td style="min-width: 200px">
                                                            <input id="input_satuan_supir_{{$numpegawai}}"
                                                                type="number"
                                                        ...
                                                        <td style="min-width: 200px">
                                                            <input id="input_jumlah_supir_{{$numpegawai}}"
                                                                type="number"
                                                ...
                                                @elseif ($pegawai->fasilitas_id == $perangkat->id && $info->jenis_program == 'Penugasan' && $pegawai->kode == 'harian')
                                                    <tr>
                                                        ...
                                                        {{-- NO AKUN PEGAWAI --}}
                                                        <td >
                                                            <select class="js-example-basic-single-3 form-select" aria-label="Default select example" style="min-width: 300px" name="akunPegawaiPenugasan_{{$numpegawai}}">
                                                                @foreach ($akuns as $akun)
                                                                    <option value="{{$akun->idAkun}}">[{{$akun->kode_satker}}.{{$akun->kode_program}}.{{$akun->kode_kegiatan}}.{{$akun->kode_output}}.{{$akun->kode_sub_output}}.{{$akun->kode_komponen}}.{{$akun->kode_sub_kegiatan}}.{{$akun->kode_akun}}] {{$akun->nama_sub_kegiatan}} - {{$akun->uraian}}</option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            @foreach ($nonpegawais as $nonpegawai)
                                                @if ($nonpegawai->fasilitas_id == $perangkat->id && $nonpegawai->kode == 'honor')
                                                    <tr>
                                                        ...
                                                        <input id="detail_satuan_non_{{$numnonpegawai}}"
                                                        type="hidden"
                                                        value="{{$nonpegawai->detail_satuan}}">
                                                ...
                                                <tr>
                                                        ...
                                                        <td style="min-width: 200px">
                                                            <input id="input_jumlah_honorarium_non_{{$numnonpegawai}}"
                                                                    ...
                                                                    min="0"
                                                                    name="jumlah_honorarium_non_{{$numnonpegawai}}"
                                                                    value="{{$nonpegawai->nominal_perjadin}}"
                                                                    readonly>
                                                        </td>
                  ...
                  <style>
                    .form-check-input:checked {
                        background-color: #28a5f64;
                        border-color: #28a5f64;
                    }
                  </style>
                    <!-- Tambahan Toggle Switch -->
                    <div class="col-md-12 mb-3">
                        <div class="d-flex align-items-center mb-3">
                            <label class="me-3 fw-bold">Gunakan detail waktu yang berbeda?</label>
                            <label class="form-check-label me-2">Tidak</label>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="different_time" name="different_time" value="yes">
                                <label class="form-check-label" for="different_time">Ya</label>
                            </div>
                        </div>
                        <!-- Input kecil dan satuan, disembunyikan secara default -->
                        <div id="time_input_container" style="display: none;">
                            <div class="d-flex align-items-center" style="gap: 10px;">
                                <input type="number" class="form-control" id="time_value" name="time_value" style="width: 100px;" min="0" placeholder="Masukkan waktu">
                                <select class="form-select" id="time_unit" name="time_unit" style="width: 100px;">
                                                            ...
                                                            value="{{$pegawai->detail_satuan}}">
                                                                ...
                                                                @foreach ($keuangans as $keuangan)
                                                                    @if ($keuangan->perangkat_acara == $pegawai->idPerangkatAcara && $keuangan->operasional != NULL)
                                                                        {{-- AKUN 2 PANITIA --}}
                                                                        <td >
                                                                            <select class="js-example-basic-single-3 form-select" aria-label="Default select example" style="min-width: 300px" name="akunHarianPegawai_{{$numpegawai}}">
                                                                                @foreach ($akuns as $akun)
                                                                        ...
                                                                        <td style="min-width: 200px">
                                                                            <input type="number" id="harianPegawai_{{$numpegawai}}" class="form-control harian-pegawai  prevent-submit" min="0" name="harianPegawai_{{$numpegawai}}" value="{{$keuangan->uang_harian}}">
                                                                        </td>

                                                                        {{-- HARIAN LAINNYA PEGAWAI SUPIR --}}
                                                                        <td style="min-width: 200px">
                                                                            <input type="number" id="hariandayPegawai_{{$numpegawai}}" class="form-control  harianday-pegawai prevent-submit" min="0" name="hariandayPegawai_{{$numpegawai}}" value="{{$keuangan->uang_harian_fullday}}">
                                                                        </td>

                                                                        {{-- REPRESENTASI PEGAWAI SUPIR --}}
                                                                        <td style="min-width: 200px">
                                                                            <input type="number" id="representasiPegawai_{{$numpegawai}}" class="form-control representasi-pegawai  prevent-submit" min="0" name="representasiPegawai_{{$numpegawai}}" value="{{$keuangan->uang_harian_representasi}}">
                                                                        </td>
                                                                        ...
                                                                        {{-- TGL BAYAR PEGAWAI --}}
                                                                        <td style="min-width: 200px">
                                                                        <input required type="datetime-local" class="result form-control" name="tglbayarPegawai_{{$numpegawai}}" value="{{$keuangan->tgl_bayar}}">
                                                                        </td>
                                                ...
                                                @if ($nonpegawai->fasilitas_id == $perangkat->id )
                                                    <tr>
                                                        ...
                                                        {{-- NO AKUN NON PEGAWAI --}}
                                                            ...
                                                            <td style="min-width: 120px">
                                                                <div class="input-group mb-3">
                                                                    <input id="input_pph_non_{{$numnonpegawai}}"
                                                                        type="number"
                                                                        step="0.1"
                                                            ...
                                                            <td style="min-width: 200px">
                                                            <input id="input_nilai_pph_non_{{$numnonpegawai}}"
                                                                    type="number"
                                                        ...
                                                        @if ($keuangan->perangkat_acara == $nonpegawai->idPerangkatAcara && $keuangan->kode == 'harian')
                                                            ...
                                                            <td style="min-width: 200px">
                                                                ...
                                                                <select class="js-example-basic-single-3 form-select akun-dropdown" aria-label="Default select example" style="min-width: 300px" name="akunHarianNonPegawai_{{$numnonpegawai}}">
                                                                    @foreach ($akuns as $akun)
                                                                        @if ($keuangan->akun_x_rkakl == $akun->idAkun)
                                                                            <option value="{{$akun->idAkun}}" selected>[{{$akun->kode_satker}}.{{$akun->kode_program}}.{{$akun->kode_kegiatan}}.{{$akun->kode_output}}.{{$akun->kode_sub_output}}.{{$akun->kode_komponen}}.{{$akun->kode_sub_kegiatan}}.{{$akun->kode_akun}}] {{$akun->nama_sub_kegiatan}} - {{$akun->uraian}}</option>
                                                                        @endif
                                                            ...
                                                            <td style="min-width: 200px">
                                                                <input type="number" id="harianNonPegawai_{{$numnonpegawai}}" class="form-control harian-nonpegawai prevent-submit" min="0" name="harianNonPegawai_{{$numnonpegawai}}" value="{{$keuangan->uang_harian}}">
                                                            </td>

                                                            {{-- UANG HARIAN LAINNYA NON PEGAWAI --}}
                                                            <td style="min-width: 200px">
                                                                <input type="number" id="hariandayNonPegawai_{{$numnonpegawai}}" class="form-control harianday-nonpegawai prevent-submit" min="0" name="hariandayNonPegawai_{{$numnonpegawai}}" value="{{$keuangan->uang_harian_fullday}}">
                                                            </td>

                                                            {{-- UANG REPRESENTASI NON PEGAWAI --}}
                                                            <td style="min-width: 200px">
                                                                <input type="number" id="representasiNonPegawai_{{$numnonpegawai}}" class="form-control representasi-nonpegawai prevent-submit" min="0" name="representasiNonPegawai_{{$numnonpegawai}}" value="{{$keuangan->uang_harian_representasi}}">
                                                            </td>
                                                        ...
                                                        <td style="min-width: 200px">
                                                            <input required type="datetime-local" class="result form-control" name="tglbayarNonPegawai_{{$numnonpegawai}}" value="{{$keuangan->tgl_bayar}}">
                                                        </td>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-center">
                      ...
                      <!-- Tombol untuk membuka modal -->
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#alasanPenolakanModal">
                            Tolak Program Kegiatan
                        </button>
                      <!-- Tombol untuk membuka modal -->
                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#alasanKembalikanModal">
                            Kembalikan ke Verifikator
                        </button>
                      <!-- <button class="btn btn-info text-white" type="submit" name="action" value="revisi">Revisi</button> -->
                      <button class="btn btn-primary submitButton" type="submit" name="action" value="selesai-tanpa-bayar">Selesaikan Tanpa Pembayaran</button>

                      @if ($info->is_acceptBend == 'approval-1')
                      <button class="btn btn-success" type="submit" name="action" value="approve-1">Approv Kegiatan</button>
                      <button class="btn btn-warning text-white" type="submit" name="action" value="simpan-draft-apv1">Simpan Draft</button>
                      @endif
                      @if ($info->is_acceptBend == 'approval-2')
                      <button class="btn btn-success" type="submit" name="action" value="approve-2">Approv Kegiatan dan selesaikan</button>
                      <button class="btn btn-warning text-white" type="submit" name="action" value="simpan-draft-apv2">Simpan Draft</button>
                      @endif
                      @else
                      <a href="{{url('/kegiatan-bendahara/' . 'approval-1')}}" class="btn btn-dark">Kembali</a>
                      @endif
...
<div class="modal fade" id="alasanKembalikanModal" tabindex="-1" aria-labelledby="kembalikanModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-warning">
            <div class="modal-header bg-warning text-dark">
                <h5 class="modal-title" id="kembalikanModalLabel">
                    <i class="bi bi-exclamation-triangle-fill"></i> Konfirmasi Pengembalian Ajuan
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ url('/cu_kegiatan_bendahara') }}" method="post">
                ...
                <div class="modal-body">
                    <div class="alert alert-warning d-flex align-items-center" role="alert">
                        ...
                        Apakah Anda yakin ingin mengembalikan ajuan kegiatan ini ke Verifikator untuk diperiksa kembali?
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="submit" class="btn btn-danger" name="action" value="kembali_verifikator">Ya, Kembalikan</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        // Fungsi untuk memperbarui semua satuan_non_ yang sesuai
        function updateAllSatuan() {
            const differentTime = document.getElementById('different_time').checked;
            const timeValue = parseFloat(document.getElementById('time_value').value) || 0;
            const timeUnit = document.getElementById('time_unit').value;

            // Cari semua input satuan_ dan detail_satuan_
            const satuanInputs = document.querySelectorAll('[id^="satuan_"]');
            satuanInputs.forEach(input => {
                const numpegawai = input.id.split('_').pop();
                console.log("NUMPEGAWAI_: "+ numpegawai)
                const detailSatuan = document.getElementById(`detail_satuan_${numpegawai}`).value;

                // Update satuan_ hanya jika toggle aktif dan detail_satuan_ sesuai dengan time_unit
                if (differentTime && detailSatuan === timeUnit) {
                    input.value = timeValue;
                    // Panggil updateTotalNon untuk memperbarui total
                    updateTotal(numpegawai);
                }
            });

            const satuanHonorInputs = document.querySelectorAll('[id^="input_satuan_honorarium_"]');
            satuanHonorInputs.forEach(input => {
                const numpegawai = input.id.split('_').pop();
                console.log("NUMPEGAWAI_: "+ numpegawai)
                const detailSatuan = document.getElementById(`detail_satuan_${numpegawai}`).value;
            ...
            satuanNonInputs = document.querySelectorAll('[id^="satuan_non_"]');
            satuanNonInputs.forEach(input => {
                const numnonpegawai = input.id.split('_').pop();
                console.log("NUMNONPEGAWAI_: "+ numnonpegawai)
                const detailSatuanNon = document.getElementById(`detail_satuan_non_${numnonpegawai}`).value;

                // Update satuan_ hanya jika toggle aktif dan detail_satuan_ sesuai dengan time_unit
                if (differentTime && detailSatuanNon === timeUnit) {
                    input.value = timeValue;
                    // Panggil updateTotalNon untuk memperbarui total
            ...
            const satuanHonorNonInputs = document.querySelectorAll('[id^="input_satuan_honorarium_non_"]');
            satuanHonorNonInputs.forEach(input => {
                const numnonpegawai = input.id.split('_').pop();
                console.log("NUMNONPEGAWAI_: "+ detail_satuan_non_)
                const detailSatuanNon = document.getElementById(`detail_satuan_non_${numnonpegawai}`).value;
        ...
        document.getElementById('different_time').addEventListener('change', function() {
        ...
        // Event listener untuk input time_value dan time_unit
        document.getElementById('time_value').addEventListener('input', updateAllSatuan);
        document.getElementById('time_unit').addEventListener('change', updateAllSatuan);
    });
...
<script>
  ...
  $(document).ready(function() {
    ...
    // Event listener for the first dropdown
    $('select[name="akunHarianPegawai_0"]').on('change', function() {
        // Get the selected value
        var selectedValue = $(this).val();
        // Get the selected text
        var selectedText = $(this).find("option:selected").text();
        ...
        // Iterate over all other dropdowns and set the selected value
        $('select[name^="akunHarianPegawai_"]').not(this).each(function() {
            $(this).val(selectedValue).trigger('change');
            $(this).find("option:selected").text(selectedText);
        });
        // Iterate over all other dropdowns and set the selected value
        $('select[name^="akunHarianNonPegawai_"]').not(this).each(function() {
            $(this).val(selectedValue).trigger('change');
            $(this).find("option:selected").text(selectedText);
        });
    ...
    $('select[name="akunPegawaiPenugasan_0"]').on('change', function() {
      // Get the selected value
      var selectedValue = $(this).val();
      // Get the selected text
      var selectedText = $(this).find("option:selected").text();
      ...
      // Iterate over all other dropdowns and set the selected value
      $('select[name^="akunPegawaiPenugasan_"]').not(this).each(function() {
        $(this).val(selectedValue).trigger('change');
        $(this).find("option:selected").text(selectedText);
      });
