...
<body>
    ...
    <center>
            ...
            <table width="500">
                ...
                <tr>
                    <td class="judul">HONORARIUM PANITIA KEGIATAN</td>
                </tr>
                <tr>
            ...
            <br>
            <table width="530" border="1" cellpadding="5" cellspacing="2"  style="border-collapse: collapse; font-size: 10px; border: 1px solid black;" >

                <thead class="text-center" >
                    <tr class="text-center small">
                        <th >No</th>
                        <th >Nama</th>
                        <th >Kedudukan <br>dalam Pengurus</th>
                ...
                <tbody >
                    ...
                    <tr class="template">
                      ...
                      <td class="template">{{$data['sebagai']}}</td>
                ...
                <tfoot>
                    <tr>
                        <td colspan="5" class="fw-bold text-end" style="">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
