              ...
              <div class="row page_content page_5">
                  ...
                  <div class="col-md-12 mb-3">
                    <div class="d-grid gap-2 d-md-flex justify-content-center">
                      ...
                      <button type="button" class="btn btn-primary btn-submit-partial">Kirim AJAX</button>
...
<script>
    $('.btn-submit-partial').on('click', function () {
        const formData = new FormData($('#form-id')[0]);

        // Tambah token CSRF secara manual
        formData.append('_token', $('input[name="_token"]').val());

        $.ajax({
            url: '{{ route("cu_kegiatan_bendahara") }}', // sesuaikan dengan route kamu
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            beforeSend: function () {
                $('.btn-submit-partial').text('Mengirim...').prop('disabled', true);
            },
            ...
            complete: function () {
                $('.btn-submit-partial').text('Kirim AJAX').prop('disabled', false);
            }
        });
    });
</script>
