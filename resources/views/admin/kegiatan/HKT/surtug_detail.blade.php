...
<body>
    ...
    <center>
        ...
        <table width="500">
            @foreach($datas['surtugs'] as $surtug)
            <tr>
                <td class="template" style="padding-bottom:10px;">{!! $surtug->perihal !!}</td>
            </tr>
            @endforeach
        </table>
            ...
            <table width="500" border="1" cellpadding="5" cellspacing="0" style="border-color: black; font-size: 14px;">
                ...
                <tbody>
                    ...
                    <tr  >
                        ...
                        @if (isset($peserta->NIP_NIK) && $peserta->NIP_NIK != "-")
        ...
        <table width="500">
            <tr>
                <td class="template" style="padding-bottom:15px;">{!! $surtug->paragraf_1 !!}</td>
            </tr>
        </table>
        @endforeach
        ...
        <table width="500">
            <tr>
                <td class="template" style="padding-bottom:15px;">{!! $surtug->paragraf_2 !!}</td>
            </tr>
        </table>
        @endforeach
        ...
        <table width="500">
            <tr>
                <td class="template" style="padding-bottom:27px;">{!! $surtug->paragraf_3 !!}</td>
            </tr>
        </table>
        @endforeach
