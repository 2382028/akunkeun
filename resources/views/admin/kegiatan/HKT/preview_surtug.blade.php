                ...
                <div class="card border-0 bg-secondary">
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <a href="{{ url('/kegiatan-HKT/surtug/edit/' . $kegiatan->id) }}" class="btn btn-dark btn-block">
                                Kembali
                            </a>
                        </div>
                        <div class="col-4">
                            <a href="{{ url('/kegiatan-HKT/surtug/preview/' . $kegiatan->id) }}" target="_blank" class="btn btn-primary btn-block">
                                Cetak
                            </a>
                        </div>
                        <div class="col-4">
                            <form action="{{ url('/c_kegiatan_HKT') }}" method="POST">
                                @csrf <!-- Tambahkan CSRF token jika menggunakan Laravel -->
                                <input type="hidden" name="idKegiatan" value="{{$kegiatan->id}}">
                                <input type="hidden" name="kegiatanStatus" value="{{$kegiatan->is_acceptHKT}}">
                    ...
                    <div class="card-body content">
                        <div class="row page_content card-style">
                            ...
                            <center>
                                ...
                                <!-- Template 3: Paragraf 1 (Informasi kegiatan) -->
                                @foreach($surtugs as $surtug)
                                <table width="500">
                                    <tr>
