@extends('admin.templates.sidebar')
    ...
    @php
        ...
        $tglMulai = Carbon::parse($kegiatan->tgl_mulai)->startOfDay();
        $tglSelesai = Carbon::parse($kegiatan->tgl_selesai)->endOfDay();
...
<div class="row">
  <form action="{{ url('/cu_kegiatan_HKT') }}" method="POST">
    @csrf
              ...
              <div class="col-md-6">
                <div class="page_content card-style">
                  ...
                  <div class="input-group">
                        ...
                        <div id="editorPerihal" style="height: 60px;">
                      ...
                      <div class="input-group">
                          ...
                          <div id="editorP1" style="height: 80px;">
                              <!-- Isi default dari paragraf 2 -->
                                @if ($jumlahHari > 1)
                                <textarea class="form-control" aria-label="With textarea" name="paragraf1" id="paragraf1" placeholder="">untuk melaksanakan tugas {!! $kegiatan->nama_kegiatan !!} pada hari {!! \Carbon\Carbon::parse($kegiatan->tgl_mulai)->translatedFormat('l') !!}, tanggal {!! \Carbon\Carbon::parse($kegiatan->tgl_mulai)->translatedFormat('d F Y') !!} s.d hari {!! \Carbon\Carbon::parse($kegiatan->tgl_selesai)->translatedFormat('l') !!}, tanggal {!! \Carbon\Carbon::parse($kegiatan->tgl_selesai)->translatedFormat('d F Y') !!} bertempat di {!! $kegiatan->alamat !!}, perjalanan dengan menggunakan Kendaraan Dinas. Segala biaya yang berhubungan dengan pelaksanaan tugas ini dibebankan kepada DIPA LLDIKTI Wilayah IV tahun {{ \App\Models\Versi::find(session('versi'))->versi ?? '' }}
                                </textarea>
                                @else
                                <textarea class="form-control" aria-label="With textarea" name="paragraf1" id="paragraf1" placeholder="">untuk melaksanakan tugas {!! $kegiatan->nama_kegiatan !!} pada hari {!! \Carbon\Carbon::parse($kegiatan->tgl_mulai)->translatedFormat('l') !!}, tanggal {!! \Carbon\Carbon::parse($kegiatan->tgl_mulai)->translatedFormat('d F Y') !!} bertempat di {!! $kegiatan->alamat !!}, perjalanan dengan menggunakan Kendaraan Dinas. Segala biaya yang berhubungan dengan pelaksanaan tugas ini dibebankan kepada DIPA LLDIKTI Wilayah IV tahun {{ \App\Models\Versi::find(session('versi'))->versi ?? '' }}
                                </textarea>
                                @endif
                          </div>
                    ...
                    <div class="col-md-6">
                        <div class="page_content card-style">
                          ...
                          <div class="input-group">
                              ...
                              <div id="editorP2" style="height: 60px;">
                                  <!-- Isi default dari paragraf 2 -->
