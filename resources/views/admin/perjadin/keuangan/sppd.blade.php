    ...
    <center>
        ...
        <table width="550" class="rincian" border="1" style="max-width: 550px; margin-top:10px;">
            ...
            <tr>
                ...
                <td colspan="2">a. Bandung<br>b. {{ $pesertaPegawai->kabupaten_kota }}</td>
            </tr>
            <tr>
                <td align="center">7</td>
                <td>a. Lamanya perjalanan dinas<br>b. Tanggal berangkat<br>c. Tanggal harus kembali/tiba di tempat baru *)</td>
                <td colspan="2" style="vertical-align: top;">a. {{ $hariPerjalanan }} ({{ $terbilangHari }}) hari<br>b. {{ \Carbon\Carbon::parse($pesertaPegawai->tgl_keberangkatan)->translatedFormat('d F Y') }}<br>c. {{ \Carbon\Carbon::parse($pesertaPegawai->tgl_selesai)->translatedFormat('d F Y') }}</td>
            </tr>
            <tr>
        ...
        <table width="550">
            ...
            <tr>
                ...
                <td align="left">
                    ...
                    <br>Pada Tanggal: {{ \Carbon\Carbon::parse($pesertaPegawai->tgl_keberangkatan)->translatedFormat('d F Y') }}
                    <br>...................................................................
...
@php
$keberangkatan = \Carbon\Carbon::parse($pesertaNonPegawai->tgl_keberangkatan);
    ...
    <center>
        ...
        <table width="550" class="rincian" border="1" style="max-width: 550px; margin-top:10px;">
            ...
            <tr>
                <td align="center">6</td>
                <td>a. Tempat berangkat<br>b. Tempat tujuan</td>
                <td colspan="2">a. Bandung<br>b. {{ $pesertaNonPegawai->kabupaten_kota }}</td>
            </tr>
            <tr>
                <td align="center">7</td>
                <td>a. Lamanya perjalanan dinas<br>b. Tanggal berangkat<br>c. Tanggal harus kembali/tiba di tempat baru *)</td>
                <td colspan="2" style="vertical-align: top;">a. {{ $hariPerjalanan }} ({{ $terbilangHari }}) hari<br>b. {{ \Carbon\Carbon::parse($pesertaNonPegawai->tgl_keberangkatan)->translatedFormat('d F Y') }}<br>c. {{ \Carbon\Carbon::parse($pesertaNonPegawai->tgl_selesai)->translatedFormat('d F Y') }}</td>
            </tr>
            <tr>
                <td align="center">8</td>
                <td>Pengikut: Nama
    ...
    <center>
        <table width="550">
            ...
            <tr>
                ...
                <td align="left">
                    Dikeluarkan di Bandung
                    <br>Pada Tanggal: {{ \Carbon\Carbon::parse($pesertaNonPegawai->tgl_keberangkatan)->translatedFormat('d F Y') }}
                    <br>...................................................................
                    <br>Pejabat Pembuat Komitmen
                    <br><br><br><br><br><br>
                    {{ $datas['pegawaiMaster']->nama_lengkap }} <br>
    ...
    <center>
        ...
        <table width="550" class="rincian" border="1" style="max-width: 550px; margin-top:10px;">
            ...
            <tr>
                <td align="center">6</td>
                <td>a. Tempat berangkat<br>b. Tempat tujuan</td>
                <td colspan="2">a. Bandung<br>b. {{ $pengemudi->kabupaten_kota }}</td>
            </tr>
            <tr>
                <td align="center">7</td>
                <td>a. Lamanya perjalanan dinas<br>b. Tanggal berangkat<br>c. Tanggal harus kembali/tiba di tempat baru *)</td>
                <td colspan="2" style="vertical-align: top;">a. {{ $hariPerjalanan }} ({{ $terbilangHari }}) hari<br>b. {{ \Carbon\Carbon::parse($pengemudi->tgl_keberangkatan)->translatedFormat('d F Y') }}<br>c. {{ \Carbon\Carbon::parse($pengemudi->tgl_selesai)->translatedFormat('d F Y') }}</td>
            </tr>
            <tr>
                <td align="center">8</td>
                <td>Pengikut: Nama
    ...
    <center>
        <table width="550">
            ...
            <tr>
                ...
                <td align="left">
                    Dikeluarkan di Bandung
                    <br>Pada Tanggal: {{ \Carbon\Carbon::parse($pengemudi->tgl_keberangkatan)->translatedFormat('d F Y') }}
                    <br>...................................................................
                    <br>Pejabat Pembuat Komitmen
                    <br><br><br><br><br><br>
                    {{ $datas['pegawaiMaster']->nama_lengkap }} <br>
    ...
    <table class="belakangSPPD" style="table-layout: fixed; border-collapse: collapse; margin: 17px;">
        ...
        <tr>
            ...
            <td width="50%"style="text-align: left; padding:0;">
                ...
                <span style="display: inline-block; margin-left: 15px;" class="noPrint">Pada Tanggal </span><span style="display: inline-block; margin-left: 74px;"> {{ \Carbon\Carbon::parse($datas['perjadin']->tgl_keberangkatan)->translatedFormat('d F Y') }}</span><br>
        ...
        <tr>
            <td   style="text-align: left;  ">
                ...
                <span class="noPrint" style="display: inline-block;">Tiba di </span><span style="display: inline-block; margin-left: 70px;">: {{ $datas['ttdSPPD']->tempatTiba1 ?? $datas['perjadin']->kabupaten_kota }}</span><br>
                <span class="noPrint" style="display: inline-block; margin-left: 30px;">Pada Tanggal </span><span style="display: inline-block; margin-left: 36px;">: {{ \Carbon\Carbon::parse($datas['ttdSPPD']->tanggal1 ?? $datas['perjadin']->tgl_mulai)->translatedFormat('d F Y') }}</span><br>
            ...
            <td   style="text-align: left;  ">
                <span class="noPrint" style="display: inline-block; margin-left: 15px;">Berangkat dari </span><span style="display: inline-block; margin-left: 44px;">: {{ $datas['ttdSPPD']->tempatTiba1 ?? $datas['perjadin']->kabupaten_kota }}</span><br>
                <span class="noPrint" style="display: inline-block; margin-left: 15px;">Ke </span><span style="display: inline-block; margin-left: 105px;">: {{ $datas['ttdSPPD']->tempatTujuan1 ?? $datas['perjadin']->kabupaten_kota }}</span><br>
                <span class="noPrint" style="display: inline-block; margin-left: 15px;">Pada Tanggal </span><span style="display: inline-block; margin-left: 49px;">: {{ \Carbon\Carbon::parse($datas['ttdSPPD']->tanggalTujuan1 ?? $datas['perjadin']->tgl_mulai)->translatedFormat('d F Y') }}</span><br>
        ...
        <tr class="noPrint">
            ...
            <td   style="text-align: left;  ">
                <span class="noPrint"style="display: inline-block; margin-left: 15px;">Berangkat dari </span><span style="display: inline-block; margin-left: 44px;">: {{ $datas['perjadin']->kabupaten_kota }}</span><br>
                ...
                <span class="noPrint" style="display: inline-block; margin-left: 15px;">Pada Tanggal </span><span style="display: inline-block; margin-left: 49px;">: {{ \Carbon\Carbon::parse($datas['perjadin']->tgl_mulai)->translatedFormat('d F Y') }}</span><br>
                <span class="noPrint" style="display: inline-block; margin-left: 15px;">Kepala </span><span style="display: inline-block; margin-left: 83px;">: {{ $datas['ttdSPPD']->jabatan1 }}</span><br>
                <br><br>
                <span style="display: inline-block; margin-left: 15px; max-width: 200px; text-align: center; display: block;">{{ $datas['ttdSPPD']->nama1 }}</span>
                <span class="noPrint" style="display: inline-block; margin-left: 20px;">NIP</span><span style="display: inline-block; margin-left: 10px;"> {{ $datas['ttdSPPD']->nip1 }} </span><br>
        ...
        <tr>
            <td   style="text-align: left;  ">
                <span class="noPrint" style="display: inline-block; margin-right: 15px;">II.</span>
                <span class="noPrint" style="display: inline-block;">Tiba di </span><span style="display: inline-block; margin-left: 70px;">: {{ $datas['ttdSPPD']->tempatTiba2 ?? $datas['perjadin']->kabupaten_kota }}</span><br>
                <span class="noPrint" style="display: inline-block; margin-left: 30px;">Pada Tanggal </span><span style="display: inline-block; margin-left: 36px;">: {{ \Carbon\Carbon::parse($datas['ttdSPPD']->tanggal2 ?? $datas['perjadin']->tgl_mulai)->translatedFormat('d F Y') }}</span><br>
                <span  class="noPrint" style="display: inline-block; margin-left: 30px;">Kepala </span><span style="display: inline-block; margin-left: 70px;">: {{ $datas['ttdSPPD']->jabatan2 }}</span><br>
                <br><br><br>
                <span style="display: inline-block; margin-left: 30px; max-width: 200px; text-align: center; display: block;">{{ $datas['ttdSPPD']->nama2 }}</span>
                <span class="noPrint" style="display: inline-block; margin-left: 50px;">NIP</span><span style="display: inline-block; margin-left: 10px;"> {{ $datas['ttdSPPD']->nip2 }}</span><br>
            ...
            <td   style="text-align: left;  ">
                <span class="noPrint" style="display: inline-block; margin-left: 15px;">Berangkat dari </span><span style="display: inline-block; margin-left: 44px;">: {{ $datas['ttdSPPD']->tempatTiba2 ?? $datas['perjadin']->kabupaten_kota }}</span><br>
                <span class="noPrint" style="display: inline-block; margin-left: 15px;">Ke </span><span style="display: inline-block; margin-left: 105px;">: {{ $datas['ttdSPPD']->tempatTujuan2 ?? $datas['perjadin']->kabupaten_kota }}</span><br>
                <span class="noPrint" style="display: inline-block; margin-left: 15px;">Pada Tanggal </span><span style="display: inline-block; margin-left: 49px;">: {{ \Carbon\Carbon::parse($datas['ttdSPPD']->tanggalTujuan2 ?? $datas['perjadin']->tgl_mulai)->translatedFormat('d F Y') }}</span><br>
        ...
        <tr  class="noPrint">
            ...
            <td   style="text-align: left;  ">
                <span style="display: inline-block; margin-left: 15px;">Berangkat dari </span><span style="display: inline-block; margin-left: 44px;">: {{ $datas['perjadin']->kabupaten_kota }}</span><br>
                ...
                <span style="display: inline-block; margin-left: 15px;">Pada Tanggal </span><span style="display: inline-block; margin-left: 49px;">: {{ \Carbon\Carbon::parse($datas['perjadin']->tgl_mulai)->translatedFormat('d F Y') }}</span><br>
        ...
        <tr>
            <td   style="text-align: left;  ">
                <span class="noPrint" style="display: inline-block; margin-right: 15px;">II.</span>
                <span class="noPrint" style="display: inline-block;">Tiba di </span><span style="display: inline-block; margin-left: 70px;">: {{ $datas['ttdSPPD']->tempatTiba3 ?? $datas['perjadin']->kabupaten_kota }}</span><br>
                <span class="noPrint" style="display: inline-block; margin-left: 30px;">Pada Tanggal </span><span style="display: inline-block; margin-left: 36px;">: {{ \Carbon\Carbon::parse($datas['ttdSPPD']->tanggal3)->translatedFormat('d F Y') }}</span><br>
                <span  class="noPrint" style="display: inline-block; margin-left: 30px;">Kepala </span><span style="display: inline-block; margin-left: 70px;">: {{ $datas['ttdSPPD']->jabatan3 }}</span><br>
                <br><br>
                <span style="display: inline-block; margin-left: 30px; max-width: 200px; text-align: center; display: block;">{{ $datas['ttdSPPD']->nama3 }}</span>
            ...
            <td   style="text-align: left;  ">
                <span class="noPrint" style="display: inline-block; margin-left: 15px;">Berangkat dari </span><span style="display: inline-block; margin-left: 44px;">: {{ $datas['ttdSPPD']->tempatTiba3 ?? $datas['perjadin']->kabupaten_kota }}</span><br>
                <span class="noPrint" style="display: inline-block; margin-left: 15px;">Ke </span><span style="display: inline-block; margin-left: 105px;">: {{ $datas['ttdSPPD']->tempatTujuan3 ?? $datas['perjadin']->kabupaten_kota }}</span><br>
                <span class="noPrint" style="display: inline-block; margin-left: 15px;">Pada Tanggal </span><span style="display: inline-block; margin-left: 49px;">: {{ \Carbon\Carbon::parse($datas['ttdSPPD']->tanggalTujuan3 ?? $datas['perjadin']->tgl_mulai)->translatedFormat('d F Y') }}</span><br>
        ...
        <tr class="noPrint">
            <td   style="text-align: left;  ">
                ...
                <span class="noPrint" style="display: inline-block;">Tiba di </span><span style="display: inline-block; margin-left: 70px;">: {{ $datas['perjadin']->kabupaten_kota }}</span><br>
                <span class="noPrint" style="display: inline-block; margin-left: 30px;">Pada Tanggal </span><span style="display: inline-block; margin-left: 36px;">: {{ \Carbon\Carbon::parse($datas['perjadin']->tgl_mulai)->translatedFormat('d F Y') }}</span><br>
        ...
        <tr>
            <td   style="text-align: left;  ">
                <span class="noPrint" style="display: inline-block; margin-right: 15px;">II.</span>
                <span class="noPrint" style="display: inline-block;">Tiba di </span><span style="display: inline-block; margin-left: 70px;">: {{ $datas['ttdSPPD']->tempatTiba4 ?? $datas['perjadin']->kabupaten_kota }}</span><br>
                <span class="noPrint" style="display: inline-block; margin-left: 30px;">Pada Tanggal </span><span style="display: inline-block; margin-left: 36px;">: {{ \Carbon\Carbon::parse($datas['ttdSPPD']->tanggal4 ?? $datas['perjadin']->tgl_mulai)->translatedFormat('d F Y') }}</span><br>
                <span  class="noPrint" style="display: inline-block; margin-left: 30px;">Kepala </span><span style="display: inline-block; margin-left: 70px;">: {{ $datas['ttdSPPD']->jabatan4 }}</span><br>
                <br><br><br>
                <span style="display: inline-block; margin-left: 30px; max-width: 200px; text-align: center; display: block;">{{ $datas['ttdSPPD']->nama4 }}</span>
                <span class="noPrint" style="display: inline-block; margin-left: 50px;">NIP</span><span style="display: inline-block; margin-left: 10px;"> {{ $datas['ttdSPPD']->nip4 }}</span><br>
            ...
            <td   style="text-align: left;  ">
                <span class="noPrint" style="display: inline-block; margin-left: 15px;">Berangkat dari </span><span style="display: inline-block; margin-left: 44px;">: {{ $datas['ttdSPPD']->tempatTiba4 ?? $datas['perjadin']->kabupaten_kota }}</span><br>
                <span class="noPrint" style="display: inline-block; margin-left: 15px;">Ke </span><span style="display: inline-block; margin-left: 105px;">: {{ $datas['ttdSPPD']->tempatTujuan4 ?? $datas['perjadin']->kabupaten_kota }}</span><br>
                <span class="noPrint" style="display: inline-block; margin-left: 15px;">Pada Tanggal </span><span style="display: inline-block; margin-left: 49px;">: {{ \Carbon\Carbon::parse($datas['ttdSPPD']->tanggalTujuan4 ?? $datas['perjadin']->tgl_mulai)->translatedFormat('d F Y') }}</span><br>
        ...
        <tr>
            <td   style="text-align: left;  ">
                ...
                <div style="text-align: right; margin-top:-30px;">
                    <span style="display: inline-block; margin-right: 125px;">{{ \Carbon\Carbon::parse($datas['perjadin']->tgl_selesai)->translatedFormat('d F Y') }}</span>
                </div>
