        ...
        <div class="col-md-12 mb-2">
          <div class="card border-0 bg-secondary">
            <div class="page wrapper">
                <a href="{{url('/perjadin-keuangan/' . 'verifikasi-1')}}" class="page-wrap btn btn-sm btn-primary">Verifikator Tahap 1 | Pengajuan</a>
                <a href="{{url('/perjadin-keuangan/' . 'verifikasi-2')}}" class="page-wrap btn btn-sm btn-warning text-white">Verifikator Tahap 2 | Pelaporan</a>
                <a href="{{url('/perjadin-keuangan/' . 'revisi-1')}}" class="page-wrap btn btn-sm btn-info text-white">Revisi-1 (Pengajuan)</a>
                  ...
                  <table id="example" class="table table-bordered data-table" style="width: 100%">
                    <thead>
                      <tr class="text-center small">
                        ...
                        <th class="th-md">Nomor Surat Tugas</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{$perjadin->status_pengajuan}} | {{$perjadin->is_acceptKeu}}</td>
                            <td>
                              <span class="page d-flex justify-content-center align-items-center">
                                <a href="{{url('/perjadin-keuangan/detail/' . $perjadin->id)}}" class="page-wrap btn btn-primary d-flex"><i class="fa-solid fa-check pt-1"></i> <p class="ps-1  m-0">Verifikasi </p></a>
                              </span>
