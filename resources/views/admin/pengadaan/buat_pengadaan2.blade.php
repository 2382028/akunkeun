          ...
          <div class="card-body content ms-3">
            ...
            <div class="mb-3 row">
              ...
              <div class="btns-group d-grid gap-2 col-1 ms-auto pb-3 mt-5" style="margin-right: 80px;">
                  <button type="submit" class="btn btn-sm btn-dark" style="padding: 8px 13px; border-radius: 5px; background-color: #052279; border-color: #052279; color: white;">Simpan</button>
              </div>
          </div>
        </div>
      </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height: 500px; overflow-y: auto;">
                ...
                <div id="previewTemplate">
                    <div style="text-align: right;">Tanggal: <span id="previewTanggalSurat">-</span></div>
                    <h4 style="text-align: center;">Undangan</h4>
                    <p>Nomor Surat: <span id="previewNoSurat">-</span></p>
                    <p>Perihal: <span id="previewPerihal">-</span></p>
                    <p>Kepada Yth,</p>
                    <p>Di tempat,</p>
                    <p>Dengan hormat,</p>
                    <p>Kami mengundang Anda untuk mengikuti kegiatan <span id="previewJenisUndangan">-</span> yang akan dilaksanakan pada:</p>
                    <ul>
                        <li>Tempat: <span id="previewTempatPelaksanaan">-</span></li>
                        <li>Telepon: <span id="previewTelepon">-</span></li>
                        <li>Website: <span id="previewWebsite">-</span></li>
                    </ul>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body ms-5 me-5">
                ...
                <div id="additionalFields" style="display: none;">
                  ...
                  <div class="container">
                      <div class="mb-5"> <!-- Margin bawah -->
                          <table class="table table-bordered" id="dataTable" style="width: 100%; table-layout: auto;">
                              <thead>
                                  <tr>
                                      <th>No</th>
                                      ...
                                      <th>Satuan</th>
                                      <th>Harga Satuan</th>
                                      <th>Jumlah Harga</th><th id="aksiHeader" style="display: none;">Aksi</th> <!-- Kolom Aksi -->
                                  </tr>
                              </thead>
                              <tbody>
                                <tr>
                                    <td colspan="7" class="text-center" id="emptyMessage">Belum Ada Data Ditambahkan</td>
                                </tr>
                            </tbody>
                          </table>
                      </div>
...
document.getElementById('nextBtn').addEventListener('click', function() {
    ...
    // Jika semua input terisi, lanjutkan ke step 2
    document.getElementById('step1').style.display = 'none';
    document.getElementById('step2').style.display = 'block';
