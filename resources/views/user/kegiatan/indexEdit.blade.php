            ...
            <div class="col-md-10 mb-3">
                ...
                <div class="card shadow rounded-0 border-0 p-4" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/c_detailKegiatan/' . $kegiatan->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card shadow-sm border-0 mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-select" name="jenis_program" required disabled>
...
<!-- Modal Notifikasi -->
<div class="modal fade" id="jenisProgramModal" tabindex="-1" aria-labelledby="jenisProgramModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-warning">
        <h5 class="modal-title" id="jenisProgramModalLabel">Perhatian</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        Jenis Program yang telah disimpan tidak dapat diubah kembali.<br>
        Jika Anda perlu melakukan perubahan pada Jenis Program, silakan buat draft ajuan baru.<br><br>
...
<!-- Script agar modal otomatis tampil saat halaman load -->
<script>
document.addEventListener('DOMContentLoaded', function() {
    var myModal = new bootstrap.Modal(document.getElementById('jenisProgramModal'));
    myModal.show();
});
</script>
